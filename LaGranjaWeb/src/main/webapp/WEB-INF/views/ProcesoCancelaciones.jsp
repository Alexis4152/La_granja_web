...
<link rel="stylesheet"
	...
	<script lenguaje="JavaScript" type="text/javascript"src="<c:url value="/resources/JavaScript/ScriptsCancel.js" />"></script>
...
<!-- PARTE DE LA CARGA DEBE DE IR ANTES DEL BODY -->
	...
	<div id="Encabezado">
		...
		<h1 color="white">Portal de Aplicativos Complemento Pago - Cancelaciones</h1>
...
<div class="alert alert-dark" role="alert">
  Proceso no activo.
	...
	<table class="table table-striped">
			...
			<tr>
					<td id="PICP"><h5>Cancelaciones</h5></td>
