...
<script lenguaje="JavaScript" type="text/javascript"src="<c:url value="/resources/JavaScript/ScriptsCore.js" />"></script>
...
<h1 color="white">Portal de Aplicativos Complemento Pago - CoreCP</h1>
...
<th class="bg-primary" id = "acciones"><h4 text-align=center>Acciones</h4></th>
...
<tr>
<td id="PICP"><h5>CoreComPago</h5></td>
...
</c:forEach><!--  A DEFINIR POR LE BEAN  O EL PROCESO DE LOGS-->
<security:authorize ifAnyGranted="ROLE_ADMIN">
<td>
<input type="submit" 
value="Activar" 
class="btn btn-success"
id="CoreCompagoBatchActive"
name="nuevo"/>
</td>
<td>
<input type="submit" 
class="btn btn-danger" value="Desactivar" 
id="CoreCompagoBatchDesactive" align=center/>
</td>
</security:authorize>
</tr>
