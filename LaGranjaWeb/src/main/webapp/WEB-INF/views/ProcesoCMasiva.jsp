...
<div id = "Encabezado" >
	<a id="imagenredirect" href="<c:url value='Choices'/>"><img
			...
			<h1 color="white">Portal de Aplicativos Complemento Pago - CMasiva</h1>
...
<tr>
<td id="PICP"><h5>Carga Masiva</h5></td>
...
id="CargaMasivaActive"
name="nuevo"/>
</td>
<td>
<input type="submit" 
class="btn btn-danger" value="Desactivar" 
id="CargaMasivaDesactive" align=center/>
</td>
	</security:authorize>
</tr>
