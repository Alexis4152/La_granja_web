...
<script lenguaje="JavaScript" type="text/javascript"src="<c:url value="/resources/JavaScript/ScriptsTransforma.js" />"></script>
...
<!-- PARTE DE LA CARGA DEBE DE IR ANTES DEL BODY -->
	...
	<div id="Encabezado">
		...
		<h1 color="white">Portal de Aplicativos Complemento Pago - Transforma</h1>
...
<div class="alert alert-dark" role="alert">
  Proceso no activo.
	...
	<table class="table table-striped">
			...
			<tr>
	<td id="PICP"><h5>Transforma</h5></td>
			...
			<td><h5>Transforma-1.0.jar</h5></td>
				...
				<td>
						<input type="submit" value="Activar" class="btn btn-success"
							id="TransformaActive" name="nuevo" />
				</td>
				<td>
						<input type="submit" class="btn btn-danger" value="Desactivar"
							id="TransformaDesactive" align=center />
				</td>
				</security:authorize>
			</tr>
