...
<h1 color="white">Recurso no encontrado</h1>
</div> 
<br>
...
<h2>La dirección a la que intentas acceder no existe.</h2>
<h2>Escribe una dirección valida o vuelve al menu principal.</h2>
